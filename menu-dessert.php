    ...
    <div class="container my-5" id="menu">-
      ...
      <div class="menu-list mt-5">
        <ul class="justify-content-center">
          ...
          <li><a class="menu-items fw-bold" href="menu-beverage.php">Beverages</a></li>
          <li><a class="menu-items active fw-bold" href="menu-dessert.php">Desserts</a></li>
        </ul>
      </div>

      <div class="menu-items row mt-5 justify-content-center">
        <?php
        $query = "SELECT * FROM tb_menu WHERE type='dessert'";
        // panggil data
